...
METRIC_RANGES: Dict[str, List[int]] = {
    "MedCalc-Bench - MedCalc Accuracy.": [0, 1],
    "CLEAR - EM": [0, 1],
    "MTSamples - Jury Score": [1, 5],
    ...
    "MedQA - EM": [0, 1],
    "MedMCQA - EM": [0, 1],
    "MedAlign - Jury Score": [1, 5],
    "ADHD-Behavior - EM": [0, 1],
    "ADHD-MedEffects - EM": [0, 1],
    "DischargeMe - Jury Score": [1, 5],
    "ACI-Bench - Jury Score": [1, 5],
    "MTSamples Procedures - Jury Score": [1, 5],
    "MIMIC-RRS - Jury Score": [1, 5],
    "MIMIC-BHC - Jury Score": [1, 5],
    "NoteExtract - Jury Score": [1, 5],
    "MedicationQA - Jury Score": [1, 5],
    "PatientInstruct - Jury Score": [1, 5],
    "MedDialog - Jury Score": [1, 5],
    "MedConfInfo - EM": [0, 1],
    "MEDIQA - Jury Score": [1, 5],
    "MentalHealth - Jury Score": [1, 5],
    "ProxySender - EM": [0, 1],
    ...
    "MIMIC-IV Billing Code - MIMICBillingF1": [0, 1],
